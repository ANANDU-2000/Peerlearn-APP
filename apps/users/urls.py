...
urlpatterns = [
    ...
    path('dashboard/mentor/sessions/<int:session_id>/', views.mentor_session_detail, name='mentor_session_detail'),
    path('dashboard/mentor/sessions/<int:session_id>/edit/', views.mentor_session_edit, name='mentor_session_edit'),
